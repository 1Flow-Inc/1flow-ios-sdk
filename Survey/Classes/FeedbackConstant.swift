...
let kPrimaryButtonEnableColor = UIColor(red: 0.36, green: 0.37, blue: 0.93, alpha: 1.0)//UIColor(red: 0.18, green: 0.31, blue: 1.0, alpha: 1.0)
...
let kNumberButtonHightlightColor = UIColor(red: 0.36, green: 0.37, blue: 0.93, alpha: 0.21)
